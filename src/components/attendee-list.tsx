    ...
    <div className='flex flex-col gap-4'>
      <div className="flex gap-3 items-center py-3">
        ...
        <div className="px-3 w-72 py-1.5 border-white/10 border-2 rounded-lg  text-sm flex items-center gap-3">
          ...
          <input type="text" className="bg-transparent flex-1 outline-none text-sm ring-0 border-0 p-0"  placeholder="Buscar participantes..."/>
        </div>
      </div>
        ...
        <table className='w-full'>
          <thead>
            <tr className='border-b border-white/10'>
              ...
              <th className='py-3 px-4 text-sm font-semibold text-left'>Códiogo</th>
          ...
          <tbody>
            <tr className='border-b border-white/10'>
              ...
              <td className='py-3 px-4 text-sm text-zinc-300'>asdgfasdfasdf</td>
              <td className='py-3 px-4 text-sm text-zinc-300'>
